...
class RecordingOptions:
    ...
    # Keystroke capture inside Guacamole sessions. Off by default because
    # there is no output stream to detect password prompts against — the
    # time-gap heuristic is used instead, but it is imperfect.
    guac_ssh_keystrokes: bool = False
    guac_rdp_keystrokes: bool = False
    ...
    def to_dict(self) -> dict:
        return {
            ...
            "guac_ssh_keystrokes": self.guac_ssh_keystrokes,
            "guac_rdp_keystrokes": self.guac_rdp_keystrokes,
        }
    ...
    def from_dict(cls, d: dict) -> "RecordingOptions":
        return cls(
            ...
            guac_ssh_keystrokes=bool(d.get("guac_ssh_keystrokes", False)),
            guac_rdp_keystrokes=bool(d.get("guac_rdp_keystrokes", False)),
        )
